...
function task3() {function promise1(){ return new Promise((resolve, reject) => 
  ...
  function promise2(){ return new Promise((resolve, reject) => {setTimeout(() => { reject(`Проміс 2 відхилено`);  }, 2000);}); }
...
.then((data) => {
      for (const index in data) {
        console.log(`Проміс ${Number(index) + 1}: ${data[index].status}`);} })
